...
- Multi-currency equity depends on `ExchangeRates` being correctly seeded with cash assets and updated.
- If you use `ExchangeRates`, register every ledger cash asset with `add_asset!` before FX-dependent calls.
