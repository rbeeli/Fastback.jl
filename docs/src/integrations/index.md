...
Example: [Tables integration walkthrough](https://rbeeli.github.io/Fastback.jl/integrations/gen/1_Tables_integration/).
...
summary performance tables as single-row Tables.jl-compatible sources.
...
Example: [NanoDates integration walkthrough](https://rbeeli.github.io/Fastback.jl/integrations/gen/2_NanoDates_integration/).
...
Example: [Timestamps64 integration walkthrough](https://rbeeli.github.io/Fastback.jl/integrations/gen/3_Timestamps64_integration/).
