...
For equity-option symbols such as SPY or AAPL, this is a cash-settled, assignment-free proxy; see [Options limitations / IBKR mapping](docs/src/options_limitations.md).
